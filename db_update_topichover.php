...
// SQL Statements
//---------------------------------------------------------------------------//
$sql_array[] = 'INSERT INTO ' . CONFIG_TABLE . " (config_name, config_value) VALUES ('hover_char_limit','775')";
$sql_array[] = 'INSERT INTO ' . CONFIG_TABLE . " (config_name, config_value) VALUES ('hover_active', '0')";
$sql_array[] = 'INSERT INTO ' . CONFIG_TABLE . " (config_name, config_value) VALUES ('hover_show', '0')";
$sql_array[] = 'ALTER TABLE ' . USERS_TABLE . " ADD user_text_hover tinyint( 1 ) NOT NULL DEFAULT '0'";
//---------------------------------------------------------------------------//
