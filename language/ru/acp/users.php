...
$lang = array_merge($lang, array(
	...
	'CANNOT_BAN_ANONYMOUS'	=> 'Вы не можете закрыть доступ анонимномы пользователю. Права доступа для гостей могут быть заданы на соответствующей вкладке администраторского раздела.',
